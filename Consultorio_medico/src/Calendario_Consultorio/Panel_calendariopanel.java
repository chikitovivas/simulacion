 ...
 * @author Rafael
 */
public class Panel_calendariopanel extends javax.swing.JPanel {
    ...
    public Panel_calendariopanel(int fil,int col,Object[][] citas) {               
        initComponents();               
    ...
    public Panel_calendariopanel(){    //SOLO PARA PRUEBA
        initComponents();          
        this.jButton1.putClientProperty(SubstanceLookAndFeel.BUTTON_SHAPER_PROPERTY, new StandardButtonShaper());
